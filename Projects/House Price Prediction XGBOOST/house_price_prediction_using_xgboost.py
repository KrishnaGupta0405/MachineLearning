...
Original file is located at
    https://colab.research.google.com/drive/1TA96tswmXVW5ts9z8vUc0w78PRW3iX6M
...
only if it does'nt exist in the root directory
"""
...
print("Actual values:", y_test[:10])  # Print first 10 actual values
